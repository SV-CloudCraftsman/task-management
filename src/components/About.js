      ...
      <div className="w-full max-w-4xl text-left">
        <center>
          ...
          <p className="text-lg mb-6">
            ...
            manage their tasks efficiently, improve productivity, and
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-4 border rounded-lg shadow-md bg-white">
            ...
            <p>
              To provide an intuitive and powerful platform for task management,
              ensuring seamless workflow and collaboration.
            </p>
          </div>
          <div className="p-4 border rounded-lg shadow-md bg-white">
